                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Editar Nota </h4>
                                        ...
                                        <div class="">
                                            <form name="addpost" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            <h4 class="m-b-30 m-t-0 header-title"><b>imagen de la Nota</b></h4>
                                            ...
                                            <button type="submit" name="update" class="btn btn-success waves-effect waves-light">Aceptar </button>
