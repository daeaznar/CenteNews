...
?>
    ...
    <head>
        ...
        <title>CenteNews | Añadir subcategoría</title>
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Añadir Subcategoría</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Añadir Subcategoría </b></h4>
                                    <hr />
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <?php if ($msg) { ?>
                                                <div class="alert alert-success" role="alert">
                                                    <strong>¡Sucategoria creada exitosamente!</strong> <?php echo htmlentities($msg); ?>
                                                </div>
                                            <?php } ?>
                                            ...
                                            <form class="form-horizontal" name="category" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <button type="submit" class="btn btn-custom waves-effect waves-light btn-md" name="submitsubcat">Añadir </button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
