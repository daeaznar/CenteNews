...
?>
    ...
    <head>
        ...
        <title>CenteNews | Categorías</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Editar y Eliminar Categorías</h4>
                                    ...
                                    <div class="demo-box m-t-20">
                                        <div class="m-b-30">
                                            <a href="add-category.php">
                                                <button id="addToTable" class="btn btn-success waves-effect waves-light">Añadir Categoría <i class="mdi mdi-plus-circle-outline"></i></button>
                                            </a>
                                        </div>
