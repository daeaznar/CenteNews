                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Editar Subcategoría</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Editar Subcategoría </b></h4>
                                    <hr />
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <?php if ($error) { ?>
                                                <div class="alert alert-danger" role="alert">
                                                    <strong>¡Ocurrió un error, intenta de nuevo más tarde!</strong> <?php echo htmlentities($error); ?></div>
                                            <?php } ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form class="form-horizontal" name="category" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">Descrpción</label>
                                                        <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <button type="submit" class="btn btn-custom waves-effect waves-light btn-md" name="submitsubcat">Aceptar</button>
                                                    </div>
                                                </div>
