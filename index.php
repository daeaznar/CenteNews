...
<body>
  <div class="container">
    <header class="blog-header py-3">
      <div class="row flex-nowrap justify-content-between align-items-center">
        <div class="col-4 pt-1">
          <a class="text-muted" href="#">Fecha completa</a>
        </div>
        <div class="col-4 text-center">
          <h1 class="blog-header-logo text-dark" href="#">CenteNews</h1>
        </div>
    ...
    <div class="nav-scroller py-1 mb-2">
      <nav class="nav d-flex justify-content-between">
        <a class="p-2 text-muted" href="#">Últimas Noticias</a>
        <a class="p-2 text-muted" href="#">México</a>
        <a class="p-2 text-muted" href="#">Internacional</a>
        <a class="p-2 text-muted" href="#">Deportes</a>
        <a class="p-2 text-muted" href="#">Entretenimiento</a>
        <a class="p-2 text-muted" href="#">Economía</a>
  ...
  <footer class="blog-footer">
    <p>Copyright © 2020 Cente News – Todos los Derechos Reservados</p>
    <p>
